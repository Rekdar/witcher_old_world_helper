...
const WitcherPicker_1 = __importDefault(require("../pages/WitcherPicker"));
const Opponents_1 = __importDefault(require("../pages/Opponents"));
const MonsterFight_1 = __importDefault(require("../pages/MonsterFight"));
const DicePoker_1 = __importDefault(require("../pages/DicePoker"));
...
function App() {
    ...
    const router = (0, react_router_dom_1.createHashRouter)([
        ...
        {
            path: "witcherPicker",
            element: (0, jsx_runtime_1.jsx)(WitcherPicker_1.default, { t: t }),
            errorElement: (0, jsx_runtime_1.jsx)(ErrorPage_1.default, {}),
        },
        {
            path: "opponents",
            element: (0, jsx_runtime_1.jsx)(Opponents_1.default, { t: t }),
            errorElement: (0, jsx_runtime_1.jsx)(ErrorPage_1.default, {}),
        },
        {
            path: "monsterFight",
            element: (0, jsx_runtime_1.jsx)(MonsterFight_1.default, { t: t }),
            errorElement: (0, jsx_runtime_1.jsx)(ErrorPage_1.default, {}),
        },
        {
            path: "dicePoker",
            element: (0, jsx_runtime_1.jsx)(DicePoker_1.default, { t: t }),
            errorElement: (0, jsx_runtime_1.jsx)(ErrorPage_1.default, {}),
        },
        {
    ...
    return ((0, jsx_runtime_1.jsx)(react_1.Suspense, { fallback: (0, jsx_runtime_1.jsx)("div", { children: "Loading...." }), children: (0, jsx_runtime_1.jsxs)("div", { className: 'flex-wrapper mx-0 px-0 d-flex flex-column', style: {
                minHeight: '100vh',
